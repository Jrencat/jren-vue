  ...
  <div class="page">
    <section class="page-section">
      <el-row :gutter="12" style="height: 1160px">
        <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" style="height: 100%; border: 0px solid skyblue">
        ...
        <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" style="height: 100%">
          <iframe v-if="showDialog" width='100%' type='application/pdf' height='100%' :src="pdfUrl"></iframe>
        </el-col>
      </el-row>
    </section>
  </div>
